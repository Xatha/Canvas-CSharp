...
public static class Drawer
{
    ...
    public static Color GetPixelColor(in Canvas canvas, in Point pixelPosition)
    {
        ...
        unsafe
        {
            var surface = (SDL_Surface*)SDL_CreateRGBSurfaceWithFormat(0, canvas.ViewWidth, canvas.ViewHeight, 32, SDL_PIXELFORMAT_ABGR8888);
            var format = (SDL_PixelFormat*)surface->format;
            SDL_RenderReadPixels(canvas.Renderer.SdlRenderer, ref rectangle, SDL_PIXELFORMAT_ABGR8888, surface->pixels, surface->pitch);
